...
export const RevenueCard =({title, ordercount, amount}) => {
    return <div className="bg-white rounded  shadow-md p-4">
        <div className="text-gray-700 flex justify-center flex-col">
            <div className='flex'>
                ...
                <div className='ml-1 flex justify-center flex-col'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.7" stroke="currentColor" className="size-5">
        ...
        <div className="flex justify-between pt-2">
            ...
            {ordercount ? <div className='flex cursor-pointer underline font-medium text-blue-700'>
                <div className='flex'>
